...
namespace KBEngine
{
	...
	public struct WEAPONID
	{
		...
		WEAPONID(UInt32 value)
		{
			this.value = value;
		}

		public static implicit operator UInt32(WEAPONID value)
		{
			return value.value;
		}
	...
	public struct EXP
	{
		...
		public static implicit operator Int32(EXP value)
		{
			return value.value;
		}

		public static implicit operator EXP(int value)
		{
			Int32 tvalue = (Int32)value;
			return new EXP(tvalue);
		}
	...
	public struct ROUND
	{
		...
		public static implicit operator Int32(ROUND value)
		{
			return value.value;
		}

		public static implicit operator ROUND(int value)
		{
			Int32 tvalue = (Int32)value;
			return new ROUND(tvalue);
		}
	...
	public struct PROP_ID
	{
		UInt32 value;

		PROP_ID(UInt32 value)
		{
			this.value = value;
		}

		public static implicit operator UInt32(PROP_ID value)
		{
			return value.value;
		}

		public static implicit operator PROP_ID(int value)
		{
			UInt32 tvalue = (UInt32)value;
			return new PROP_ID(tvalue);
		}
	...
	public struct COLLISION_ID
	{
		Int32 value;

		COLLISION_ID(Int32 value)
		{
			this.value = value;
		}

		public static implicit operator Int32(COLLISION_ID value)
		{
			return value.value;
		}

		public static implicit operator COLLISION_ID(int value)
		{
			Int32 tvalue = (Int32)value;
			return new COLLISION_ID(tvalue);
		}
