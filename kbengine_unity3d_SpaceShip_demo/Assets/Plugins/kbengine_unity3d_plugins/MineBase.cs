/*
	...
	Please inherit this module, such as: (class Mine : MineBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	// Please inherit and implement "class Mine : MineBase"
	public abstract class MineBase : Entity
	{
		public EntityBaseEntityCall_MineBase baseEntityCall = null;
		public EntityCellEntityCall_MineBase cellEntityCall = null;
		...
		public abstract void onMineDestroy(Int32 arg1, UInt16 arg2); 
		...
		{
			baseEntityCall = new EntityBaseEntityCall_MineBase(id, className);
		}

		public override void onGetCell()
		{
			cellEntityCall = new EntityCellEntityCall_MineBase(id, className);
		}
