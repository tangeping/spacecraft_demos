/*
	...
	Please inherit this module, such as: (class SupplyBox : SupplyBoxBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	// Please inherit and implement "class SupplyBox : SupplyBoxBase"
	public abstract class SupplyBoxBase : Entity
	{
		public EntityBaseEntityCall_SupplyBoxBase baseEntityCall = null;
		public EntityCellEntityCall_SupplyBoxBase cellEntityCall = null;
		...
		public abstract void onSupplyBoxDestroy(Int32 arg1, UInt16 arg2); 

		public SupplyBoxBase()
		{
		}

		public override void onGetBase()
		{
			baseEntityCall = new EntityBaseEntityCall_SupplyBoxBase(id, className);
		}

		public override void onGetCell()
		{
			cellEntityCall = new EntityCellEntityCall_SupplyBoxBase(id, className);
		}
		...
		{
			ScriptModule sm = EntityDef.moduledefs["SupplyBox"];
			...
			{
				case 11005:
					Int32 onSupplyBoxDestroy_arg1 = stream.readInt32();
					UInt16 onSupplyBoxDestroy_arg2 = stream.readUint16();
					onSupplyBoxDestroy(onSupplyBoxDestroy_arg1, onSupplyBoxDestroy_arg2);
					break;
				default:
					break;
			};
		...
		public override void callPropertysSetMethods()
		{
			...
			UInt32 oldval_spaceUType = spaceUType;
			Property prop_spaceUType = pdatas[7];
